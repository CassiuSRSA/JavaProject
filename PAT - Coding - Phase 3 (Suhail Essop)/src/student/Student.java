    ...
    public void insert(int id, String sname, String date, String gender, String email, String phone, String father, String mother, String address1, String address2, String imagePath) {
        ...
        try {
            ...
            if (ps.executeUpdate() > 0) {
                JOptionPane.showMessageDialog(null, "New Student loaded successfully");
            }
...
//    update student value
    ...
    public void delete(int id) {
        int yesOrNo = JOptionPane.showConfirmDialog(null, "Subject and score records will also be deleted, are you sure?", "Student Delete", JOptionPane.OK_CANCEL_OPTION, 0);
